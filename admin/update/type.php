...
session_start();
		...
		mysql_query("replace into type_details (type,week_max,week_min,day_max,cont,group_id,type_id) values('".$_REQUEST ["type"]."','".$_REQUEST ["max_load"]."','".$_REQUEST ["min_load"]."','".$_REQUEST ["max_load_day"]."','".$_REQUEST ["cont_load"]."','".$_SESSION ["group_id"]."','".$_REQUEST ["type_id"]."')") or die(mysql_error());
