...
<html>
	...
	<body>
		...
		mysql_select_db($config["DB_NAME"]);
					...
					$rp=mysql_query("select * from sub_detail where group_id=".$_SESSION['group_id']." $max") or die(header("location:subject_details.php?errmsg=Insert  Details First"));
					...
					echo "<tr id='headTable'><td>Subject</td><td>Subject Type</td><td>Subject Load</td></tr>";
					
					while($row=mysql_fetch_array($rp)){
		
						echo "<tr><td><a href='update_sub.php?id=".$row['sub_id']."' class='link'>".$row['name']."</a></td><td>".$row['sub_type']."</td><td>".$row['sub_load']."</td></tr>";
